...
const BooksPage: React.FC = () => {
  ...
  const fetchBooks = async () => {
    try {
      ...
      const response = await axios.get('https://library-management-backend-nweb.onrender.com/api/view-books', {
        headers: {
  ...
  const fetchPurchasedBooks = async () => {
    try {
      ...
      const response = await axios.get(`https://library-management-backend-nweb.onrender.com/user/view-purchased-books/${userId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      for (let i = 0; i < response.data.books.length; i++) {
        ...
        const book_data = await axios.get(`https://library-management-backend-nweb.onrender.com/get-books/${bookId}`, {
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
          },
  ...
  const handleBuyBook = async (bookId: string) => {
    ...
    try {
      const response = await axios.post('https://library-management-backend-nweb.onrender.com/user/buy-book', data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
