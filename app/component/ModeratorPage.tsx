...
const ModeratorDashboard: React.FC = () => {
  ...
  const handleRentBook = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post('https://library-management-backend-nweb.onrender.com/moderator/give-book-on-rent', rentForm, config);
  ...
  const handleReturnBook = async (bookRentDetails: any) => {
    try {
      ...
      await axios.put('https://library-management-backend-nweb.onrender.com/moderator/update-book-return', bookRentDetails, config);
      ...
      <div className="rent-book-form">
        ...
        <form onSubmit={handleRentBook}>
          ...
          <div>
            ...
            <input 
              type="date" 
              value={rentForm.expected_return_date}
              onChange={(e) => setRentForm({...rentForm, expected_return_date: e.target.value})}
              required 
            />
          </div>
